...
class FortuneWheel extends HookWidget implements FortuneWidget {
  ...
  /// {@macro flutter_fortune_wheel.FortuneWidget.onIndicatorPressed}
  ...
  Widget build(BuildContext context) {
    ...
    return PanAwareBuilder(
      ...
      builder: (context, panState) {
        return Container(
          decoration: BoxDecoration(color: Color(0xffe8c568), shape: BoxShape.circle),
          padding: EdgeInsets.all(4),
          child: Container(
            decoration: BoxDecoration(color: Color(0xff40097e), shape: BoxShape.circle),
                ...
                Container(
                  ...
                  child: Stack(
                    ...
                    children: [
                            ...
                            final transformedItems = [
                              for (var i = 0; i < items.length; i++)
                                TransformedFortuneItem(
                                  item: items[i],
                                  angle: selectedAngle + panAngle + rotationAngle + _calculateSliceAngle(i, items.length),
                      ...
                      GestureDetector(child: Image.asset('$IMG_URL/indicator.png', height: 46, width: 46), onTap: onIndicatorPressed),
                    ],
                  ),
                ),
